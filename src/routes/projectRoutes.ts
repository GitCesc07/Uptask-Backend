...
import { taskAuthorizationToProject, taskBelongsToProject, taskExists } from "../middleware/task";
...
//* Código repetitivo, por ello se crea un afunción en Middleware, pero este se ejecuta según  el orden que esta llamando las funciones: 
//* Primero: taskExists, Segundo: taskBelongsToProject
...
router.post(
  ...
  body("content").notEmpty().withMessage("El contenido de la nota no puede estar vacío..."),
  handleInputErrors,
